...
if __name__ == "__main__":
    ...
    # mix_all = data_for_mc.create_final_dataset(sims_co_threshold, sims_so_threshold, mix_threshold)

    # doing all steps in one
